...
DEFAULT_TASKS = [('让 Agent 自主移动可视化', '前端接入后端状态坐标，展示 Agent 目标点、路线和当前任务。', 'su_frontend', 5, ['frontend', 'demo', 'movement']), ('DeepSeek Provider 稳定性治理', '验证真实模型、Mock 降级、超时处理和 /llm/status 观测。', 'lu_ops', 5, ['llmops', 'deepseek', 'backend']), ('多智能体办公室调度策略', '把 Agent 行为从随机 Tick 升级为基于任务、角色、地点的 Agent Policy。', 'guo_cto', 5, ['agent', 'planning', 'architecture']), ('长期记忆与上下文工程优化', '改进 Agent 对候选人、任务和办公室事件的记忆召回与 Prompt 注入。', 'shen_algo', 4, ['memory', 'prompt', 'eval']), ('Prompt Injection 与权限评审', '为 Agent 工具调用、事件日志和玩家输入建立安全边界。', 'han_security', 4, ['security', 'audit', 'guardrail']), ('投递版项目卖点包装', '把系统沉淀为简历描述、面试讲法和演示脚本。', 'yin_hr', 4, ['resume', 'interview', 'career']), ('办公室 Demo 用户旅程', '设计从进入办公室、观察自移动、对话、站会到简历输出的完整演示路径。', 'tang_pm', 4, ['product', 'demo', 'metrics'])]
